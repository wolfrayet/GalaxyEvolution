...
Ha_freq=4861
Ha_Blueside=[4800.0,4850.0]
Ha_redside=[4870.0,4900.0]
Ha_Primary=[4850.0,4870.0]  #include [NII] and Ha
...
ax1.plot(fitted_x, gaussian1(fitted_x, *par)+linear_fun(fitted_x,cont_popt[0],cont_popt[1]), color='r', linestyle='-', zorder=3, lw=1,label='H_beta')
